...
public class CreatingDynamicXpath {
	 ...
	 * 
	 * @FindBy(xpath =" //input[@id='mh-search-input' and @class='mh-search-input']")<--- Dell
	 * Technologies {Search Field}
	 *
	 * @FindBy(xpath ="//input[@id='SearchBox' and @name='HtmlSearchCriteria']") <------ Parkland Health
	 * 
	 * 
	 * @FindBy(xpath ="//input[@id='searchDesktop' and @class='header-search']") <-- https://www.pa.gov/ { Serach Field}
	 * 
	 * 
	 * 
	 * @FindBy(xpath ="//a[@id='cms-newuser-reg' and 'cms-newuser-reg']") <----- {CMS New User Reg} 
	 * 
	 * Below CMS logo
	 ...
	 * //a[text()='Login'] <--- EnhtrallIT Login Tab
	 ...
	 *  //a[contains(text(),' Account ')] <--- Dell Create An Account
	 * 
	 */
